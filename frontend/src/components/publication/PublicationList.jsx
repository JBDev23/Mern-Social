...
export const PublicationList = ({publications, getPublications, more, setMore, page, setPage}) => {
                            ...
                            <div className="post__container">
                                ...
                                <div className="post__image-user">
                                    <Link to={"/social/perfil/" + publication.user._id} className="post__image-link">
                                        {publication.user.image != "default.png" && <img src={publication.user.image} className="post__user-image" alt="Foto de perfil" />}
